      ...
      <section id="about-us" className="py-20 bg-white">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <p className="text-gray-600 text-xl leading-relaxed mb-8">
            At <b>KB ToPay Finovative LLP</b>, we are dedicated to revolutionizing how you manage your insurance. Our platform offers a seamless, secure, and efficient way to handle all your insurance payments and policy needs. We are committed to providing transparent services, innovative solutions, and unwavering support to ensure your financial security.
          </p>
